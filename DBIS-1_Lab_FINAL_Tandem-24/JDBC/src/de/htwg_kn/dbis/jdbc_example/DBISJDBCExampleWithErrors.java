...
public class DBISJDBCExampleWithErrors {
    ...
    private static void addStudent() {
        ...
        try {
            ...
            String sqlString = "INSERT INTO Student (MatrNr, FB_ID, Name, Vorname) " +
    ...
    private static void deleteStudent() {
        ...
        try {
            ...
            System.out.println("Studierende lˆschen");
            System.out.println("-----------------------------------------");
            ...
            while (flag == 1) {
                ...
                int MatrNr = DBISUtils.readIntFromStdIn("Matrikelnummer des zu lˆschenden Studierenden");
                ...
                if (affectedRows == 1) {
                    System.out.println("Der Studierende mit MatrNr " + MatrNr + " wurde gelˆscht.");
                }
                else {
                    System.out.println("Der Studierende mit MatrNr " + MatrNr + " existierte nicht.");
                }

                flag = DBISUtils.readIntFromStdIn("Weitere Studierende lˆschen (1 f¸r ja)?");
